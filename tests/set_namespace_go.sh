...
#kpt fn run . --image gcr.io/nanyu-gke-dev/set-namespace:dev2 -- namespace=example-ns
...
#      container:
#        image: gcr.io/nanyu-gke-dev/set-namespace:dev2
...
#kpt fn run example-configs/shipping-dev --image gcr.io/nanyu-gke-dev/set-namespace:dev2 -- namespace=example-ns
